    ...
    <div class="col-md-12 col-sm-12  ">
        ...
        <div class="x_content">
            ...
            <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link " href="?jenis=dasar_keuangan&tahun={{ $tahun }}" role="tab">Data Dasar Keuangan
                        <span class="fa fa-check-circle ml-1 {{ $dasar==0 ? 'd-none' : '' }}"></span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="?jenis=proposal&tahun={{ $tahun }}" role="tab">Proposal Pengajuan Modal
                        <span class="fa fa-check-circle ml-1 {{ $proposal==0 ? 'd-none' : '' }}"></span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="?jenis=laporan&tahun={{ $tahun }}" role="tab">Laoran Keuangan
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane active show " id="dalap" role="tabpanel" aria-labelledby="dalap-tab">
                    <h4 class="my-4 text-center">Silahkan klik tab untuk lihat/input/update data</h4>
                </div>
