...
<div id="status" class="d-none">open</div>
        ...
        <div class="x_content">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane active show " id="dalap" role="tabpanel" aria-labelledby="dalap-tab">
                    ...
                    @include('adminDesa.bumdes.dasarbumdesEdit')
                    @elseif($jenis=='laporan')
                    @include('adminDesa.bumdes.lapkeuEdit')
                    @elseif($jenis=='proposal')
                    @include('adminDesa.bumdes.proposalEdit')
                    @endif
                </div>
...
<script>
    ...
    function getURL(input) {
        ...
        if (cekgb == 'jpg' || cekgb == 'JPG' || cekgb == 'png' || cekgb == 'PNG' || cekgb == 'jpeg' || cekgb == 'JPEG') {
            if(input.files[0]['size'] > 1024000){
                ...
                $('#foto_rekening').val("");
                $('.foto_rekening').html("file gambar (max-size: 1MB)");
            }else{

            }

        }else {
            alert ("file harus berjenis jpg,png,jpeg ");
            $('#foto_rekening').val("");
            $('.foto_rekening').html("file gambar (max-size: 1MB)");
    ...
    $('.hapuslapkeu').on('click', function(e){
        e.preventDefault();
