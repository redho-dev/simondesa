        ...
        <div class="x_content">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane active show " id="dokumen_bumdes" role="tabpanel"
                    ...
                    @if($jenis == 'pendirian')
                    @include('adminDesa.bumdes.pendirianTambah')
                    @elseif($jenis=='kepengurusan')
                    @include('adminDesa.bumdes.pengurusTambah')
                    @endif
...
<script>
    ...
    $("#perdes_pembentukan").change(function(event) {
        getURL(this);
    });
...
function getURL(input) {
    if (input.files && input.files[0]) {
        ...
        var filename = $("#perdes_pembentukan").val();
        ...
        if (cekgb == 'pdf' || cekgb == 'PDF' ) {
            if(input.files[0]['size'] > 1024000){
                ...
                $('#perdes_pembentukan').val("");
                $('.perdes_pembentukan').html("Choose file PDF (max-size: 1MB)");
            }else{
    ...
    if (input.files && input.files[0]) {
        ...
        if (cekgb == 'pdf' || cekgb == 'PDF' ) {
            if(input.files[0]['size'] > 1024000){
                alert('ukuran file tidak boleh > 1 MB !');
                $('#ad_art').val("");
                $('.ad_art').html("Choose file PDF (max-size: 1MB)");
            }else{
...
$("#perdes_modal").change(function(event) {
        getURL4(this);
    });
    ...
    if (input.files && input.files[0]) {
        ...
        if (cekgb == 'pdf' || cekgb == 'PDF' ) {
            if(input.files[0]['size'] > 1024000){
                alert('ukuran file tidak boleh > 1 MB !');
                $('#perdes_modal').val("");
                $('.perdes_modal').html("Choose file PDF (max-size: 1MB)");
            }else{
...
$("#sk_pengurus").change(function(event) {
        getURL4(this);
    });
    ...
    if (input.files && input.files[0]) {
        ...
        if (cekgb == 'pdf' || cekgb == 'PDF' ) {
            if(input.files[0]['size'] > 1024000){
                alert('ukuran file tidak boleh > 1 MB !');
                $('#sk_pengurus').val("");
                $('.sk_pengurus').html("Choose file PDF (max-size: 1MB)");
            }else{
