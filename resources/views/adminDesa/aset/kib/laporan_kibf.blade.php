...
<head>
    ...
    <title>Laporan Hasil Invetarisasi Aset Tetap Lainnya</title>
    {{-- <!-- Bootstrap -->
...
<body>
    ...
    <p style="text-align: center"><strong>BERUPA ASET TETAP LAINNYA</strong></p><br>
    <div class="row">
        <div class="col-lg-12">
                ...
                <div>
                    <table class="table1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td></td>
                                <td colspan="7" style="margin-left: 10px; text-align: center"> Jumlah </td>
