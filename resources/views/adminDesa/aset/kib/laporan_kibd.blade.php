...
<head>
    ...
    <title>Laporan Hasil Invetarisasi Bangunan</title>
    {{-- <!-- Bootstrap -->
...
<body>
    ...
    <p style="text-align: center"><strong>BERUPA BANGUNAN</strong></p><br>
    <div class="row">
        <div class="col-lg-12">
                ...
                <div>
                    <table class="table1">
                        <thead>
                            ...
                            <th style="width: 10%; text-align: center">Jenis Bangunan</th>
                            ...
                            <th style="width: 10%; text-align: center">Type Bangunan</th>
