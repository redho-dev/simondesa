...
<head>
    ...
    <title>Laporan Hasil Invetarisasi Peralatan dan Mesin</title>
    {{-- <!-- Bootstrap -->
...
<body>
    ...
    <p style="text-align: center"><strong>BERUPA PERALATAN DAN MESIN</strong></p><br>
    <div class="row">
        <div class="col-lg-12">
                ...
                <div>
                    <table class="table1">
                        <thead>
                            ...
                            <th style="width: 10%; text-align: center">Merk / Type</th>
                            <th style="width: 7%; text-align: center">Tahun Perolehan</th>
                            <th style="width: 10%; text-align: center">Nomor Identitas</th>
                            <th style="width: 10%; text-align: center">Asal Usul Barang</th>
                            <th style="width: 7%; text-align: center">Kondisi Barang</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$Akunasetkiba->kondisi_barang}}</td>
                            ...
                            <tr>
                                <td></td>
                                <td colspan="9" style="margin-left: 10px; text-align: center"> Jumlah </td>
