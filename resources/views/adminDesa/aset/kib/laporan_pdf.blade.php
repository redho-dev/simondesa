...
<head>
    ...
    <title>Laporan Hasil Invetarisasi Tanah</title>
    {{-- <!-- Bootstrap -->
...
<body>
    ...
    <p style="text-align: center"><strong>BERUPA TANAH</strong></p><br>
    <div class="row">
        <div class="col-lg-12">
                ...
                <div>
                    <table class="table1">
                        <thead>
                            ...
                            <th style="width: 10%; text-align: center">Jenis Tanah</th>
                            <th style="width: 10%; text-align: center">Kode Barang</th>
                            <th style="width: 10%; text-align: center">NUP</th>
                            <th style="width: 10%; text-align: center">Luas m<sup>2</sup></th>
                            <th style="width: 10%; text-align: center">Tahun Perolehan</th>
                            <th style="width: 10%; text-align: center">Alas Hak/Bukti Kepemilikan</th>
                            <th style="width: 10%; text-align: center">Asal Usul Barang</th>
                            <th style="width: 15%; text-align: center">Keterangan</th>
                            <th style="width: 10%; text-align: center">Nilai Perolehan</th>
                            </tr>
                        </thead>
                        <tbody>
