...
<div class="row justify-content-center mt-2">
    <div class="col-md-12 col-sm-12  ">
        <h5 class="alert alert-info">Form Update Data Kepala Dusun / Ketua RT</h5>
        <div class="mb-2">
        ...
        <div class="x_content">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <form action="/adminDesa/updateDatumRT" method="post" enctype="multipart/form-data"
                            ...
                            <div class="col-md-5 col-sm-5 ">
                                <span class="input-group-text" style="font-size: .85rem; border-radius: 0;">sejak
                                    : <input type="text" name="sejak" class="form-control mx-2"
                                        ...
                                        name="sampai" class="form-control mx-2" placeholder="tahun berakhir"
                                        style="font-size: .85rem; border-radius: 0;"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-blue">
                <h5 class="modal-title" id="staticBackdropLabel">From Salin Data RT</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                ...
                <form action="/adminDesa/copyDatumRT" method="post">
                    @csrf
                    <div class="form-group">
            ...
            <form action="/adminDesa/copyDatumRT" method="post">
                @csrf
                <div class="form-group">
                    <label for="tahuncopy" style="font-size: 1rem">Copy Seluruh Data {{ $jabatan }} ke Tahun
                        :</label>
                    <select class="form-control" id="tahuncopy" name="tahuncopy" required>
                        <option value="">== pilih tahun ==</option>
                        <option>{{ $tahun+1 }}</option>
