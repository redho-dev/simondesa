...
<div class="row justify-content-center mt-2">
    <div class="col-md-12 col-sm-12  ">
        <h5 class="alert alert-info">Form Input/Update Data Kepala Dusun / Ketua RT</h5>
        <div class="mb-2">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header bg-info">
                                <h5 class="modal-title text-light" id="staticBackdropLabel">Copy Data Kepala Dusun</h5>
                            ...
                            <div class="modal-body">
                                ...
                                <form action="/adminDesa/copyDatumDusAll" method="post">
                                    ...
                                    <div class="form-group">
                                        <label for="tahuncopy">Tetap Copy dan timpa Seluruh Data kepala dusun Tahun {{
                                            $tahun }} ke
                            ...
                            <form action="/adminDesa/copyDatumDusAll" method="post">
                                @csrf
                                <div class="form-group">
                                    <label for="tahuncopy">Copy Seluruh Data Kepala Dusun Tahun {{ $tahun }} ke Tahun
                                        :</label>
        ...
        <div class="x_content">
            ...
            <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="?jabatan=Kadus_{{ $i }}&tahun={{ $tahun }}" role="tab"
                        aria-selected="true">Kadus_{{
