        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link" href="?jenis=pengajuan&tahun={{ $tahun }}" role="tab">+ Dokumen Pengajuan &
                            Penerimaan
                            <span class="fa fa-check-circle ml-1 {{ $pengajuan>0 ? '' : 'd-none' }}"></span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="?jenis=cek_pengajuan&tahun={{ $tahun }}" role="tab">Cek Dokumen
                            Pengajuan & Penerimaan

                        </a>
                    </li>
                    <li class=" nav-item">
                        <a class="nav-link " href="?jenis=buku_pembantu_bank&tahun={{ $tahun }}" role="tab">+ Buku
                            Pembantu Bank
