<form action="/adminDesa/tambahSurveyperalatan" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">
        <div class="col-md-6">
            <p class="alert alert-info" style="font-size: .9rem">Form Input BAC / Keterangan Survey Harga
                Peralatan/Perlengkapan Kantor (Komputer/laptop, printer, alat-elektronik, mebeler dsb) </p>
        </div>
