...
<div class="row justify-content-center mt-2 mb-4">
            ...
            <div class="x_content">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        @elseif($jenis=='survey')
                        @include('adminDesa.formPengadaan.formSurveyupdate')
                        @elseif($jenis=='pilfis')
                        @include('adminDesa.formPengadaan.formPilfis_e')
                        @endif
                    </div>
    ...
    <script>
        ...
        $('.hapus').on('click', function(){
            var yakin = confirm('anda yakin hapus kegiatan?');
            if(yakin){
               var idhap = $(this).attr('idhap');
               var tr = $(this).parents('tr');
               $.get( "/adminDesa/hapusKegfis", {idhap: idhap } )
                .done(function( data ) {
                    if(data=='berhasil'){
                        Swal.fire({
                        position: 'center',
                        ...
                        position: 'center',
                        icon: 'error',
                        title: 'tidak bisa menghapus kegiatan fisik yang sudah periksa!',
                        showConfirmButton: true
                        })
                    }
