        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link" href="?jenis=pilfis&tahun={{ $tahun }}" role="tab">+ Pilih Kegiatan
                            Fisik/Konstruksi
                            <span class="fa fa-check-circle ml-1 {{ count($pilfis) ? '' : 'd-none' }}"></span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="?jenis=survey&tahun={{ $tahun }}" role="tab">Survey Harga
                            <span class="fa fa-check-circle ml-1 {{ $survey ? '' : 'd-none' }}"></span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="?jenis=realisasi&tahun={{ $tahun }}" role="tab">Realisasi
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <h4 class="text-center">klik tab untuk lihat/input/update data</h4>
                    </div>
