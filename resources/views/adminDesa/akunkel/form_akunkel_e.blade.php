                            ...
                            <div class="col-md-10">
                                <table class="table table-bordered">
                                    <tr>
                                        ...
                                        <th width="50%">
                                            <div class="form-group">
                                                <label for="sotk">Peraturan Desa Tentang Susunan Organisasi Tatakerja
                                                    (SOTK)</label>
                                        ...
                                        <th>
                                            <div class="form-group">
                                                <label for="upload_sotk">Ganti Dokumen Perdes (SOTK)</label>
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <div class="form-group">
                                                <label for="upload_sktaruna">Ganti SK Karang Taruna </label>
                                                <div class="custom-file">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <div class="form-group">
                                                <label for="upload_linmas">ganti SK Linmas
                                                </label>
                                                <div class="custom-file">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <div class="form-group">
                                                <label for="upload_kantor_desa">Ganti Foto Tampak Depan Kantor Desa
                                                </label>
                                                <div class="custom-file">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <div class="form-group">
                                                <label for="upload_kg_kdes">Ganti Foto Kegiatan di Kantor Desa
                                                </label>
                                                <div class="custom-file">
                                                    <input type="file" name="upload_kg_kdes" class="custom-file-input"
                                                        id="upload_kg_kdes">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <div class="form-group">
                                                <label for="upload_kantor_bpd">ganti Foto Sekretariat / Kantor BPD
                                                </label>
                                                <div class="custom-file">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <div class="form-group">
                                                <label for="upload_kantor_lpm">ganti Foto Sekretariat / Kantor LPM
                                                </label>
                                                <div class="custom-file">
