...
<div class="row justify-content-center mt-2">
    <div class="col-md-12 col-sm-12  ">
        <h5 class="alert alert-info">Form Input/Update Data Houder Barang</h5>
        <div class="x_panel">
            <div class="x_title">
                <div class="d-flex">
                    <form class="form-inline" action="/adminDesa/formHolder" method="get">
                        @csrf
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header bg-info">
                                <h5 class="modal-title text-light" id="staticBackdropLabel">Copy Seluruh Data Houder
                                </h5>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="alert bg-danger text-white">Sudah ada data Houder tahun {{
                                    session('timpaAll') }}
                                </div>
                                <form action="/adminDesa/copyHolderAll" method="post">
                                    @csrf
                                    <div class="form-group">
                                        <label for="tahuncopy">Tetap Copy dan timpa Data Houder Tahun {{
                                            $tahun }} ke
                            ...
                            <form action="/adminDesa/copyHolderAll" method="post">
                                @csrf
                                <div class="form-group">
                                    <label for="tahuncopy">Copy Seluruh Data Houder Tahun {{ $tahun }} ke Tahun
                                        :</label>
        ...
        <div class="x_content">
            ...
            <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" href="" role="tab">Kuasa Pemegang Barang (Houder)
                        <span class="fa fa-check-circle ml-1 {{ $holder==0 ? 'd-none' : '' }}"></span>
                    </a>
                </li>
                        ...
                        <div class="modal fade" id="staticBackdrop" data-backdrop="static" data-keyboard="false"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/adminDesa/tambahHolder" method="post"
                                            ...
                                            <div class="form-group">
                                                <label for="nama_ruangan">Nama Barang</label>
                                                <div class="input-group">
                                                    <select name="nama_barang" class="form-control"
                                                        style="font-size : .8rem">
                                                        @foreach($barangs as $br)
                                                        <option value="{{ $br->nama_barang }}">{{ $br->nama_barang }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <label for="sk_holder">Surat Kuasa Pemegang Barang (Houder) </label>
                                                <div class="input-group">
                                                    <div class="custom-file py-0">
                                                        <input type="file" name="sk_holder" class="custom-file-input"
                                                            id="sk_holder" required>
                                                        <label class="custom-file-label text-muted sk_holder"
                                                            for="sk_holder">Choose
                                                            file PDF
                                                            (max-size: 1MB)</label>
                                                    </div>
                                                </div>
                            ...
                            <table class="table table-bordered">
                                <thead class="table-secondary">
                                    <tr>
                                        ...
                                        <th>Tahun Data</th>
                                        <th>Nama Barang</th>
                                        <th class="text-center">Surat Kuasa Pemegang Barang <br>(Houder)</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><a href="{{ asset('storage/'.$data->sk_holder) }}"
                                                target="_blank">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="/adminDesa/hapusHolder/{{ $data->id }}"
                                        ...
                                        <div class="modal fade" id="edit_{{ $data->id }}" data-backdrop="static"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="/adminDesa/editHolder" method="post"
                                                            enctype="multipart/form-data">
                                                            @csrf
                                                            ...
                                                            <div class="form-group">
                                                                <label for="nama_barang_e">Nama Barang</label>
                                                                <input type="text" class="form-control"
                                                                    id="nama_barang_e" name="nama_barang_e"
                                                                    style="font-size : .8rem"
                                                                    value="{{ $data->nama_barang }}" autofocus required>

                                                            </div>


                                                            <div class="form-group">
                                                                <label for="sk_holder_e">Surat Kuasa Pemegang barang
                                                                    (Houder) </label>
                                                                <div class="input-group">
                                                                    <div class="custom-file py-0">
                                                                        <input type="hidden" name="oldPdf"
                                                                            value="{{ $data->sk_holder }}">
                                                                        <input type="file" name="sk_holder_e"
                                                                            class="custom-file-input sk_holder_e">
                                                                        <label
                                                                            class="custom-file-label text-muted sk_holder_e"
                                                                            for="sk_holder_e">Ganti
                                                                            file PDF
                                                                            (max-size: 1MB)</label>
                                                                    </div>
                                                                </div>
...
<script>
    $("#sk_holder").change(function(event) {
    ...
    function getURL2(input) {
            if (input.files && input.files[0]) {
                ...
                if (cekgb == 'pdf' || cekgb == 'PDF' ) {
                    if(input.files[0]['size'] > 1024000){
                        ...
                        $('#sk_holder').val("");
                        $('.sk_holder').html("Choose file PDF (max-size: 1MB)");
                    }else{
        ...
        $("input[name='sk_holder_e']").change(function(event) {
        ...
        function getURL(input, name) {
            if (input.files && input.files[0]) {
                ...
                if (cekgb == 'pdf' || cekgb == 'PDF' ) {
                    if(input.files[0]['size'] > 1024000){
                        alert('ukuran file tidak boleh > 1 MB !');
                        $("input[name='sk_holder_e']").val("");
                        $('.sk_holder_e').html("Choose file PDF (max-size: 1MB)");
                    }else{
