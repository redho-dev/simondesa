        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link " href="?jenis=dokumen&tahun={{ $tahun }}" role="tab">Kelengkapan Dokumen
                            <span class="fa fa-check-circle ml-1  {{ $dokumen ? '' : 'd-none' }} "></span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="?jenis=pendapatan&tahun={{ $tahun }}" role="tab">Pendapatan
                            <span class="fa fa-check-circle ml-1 {{ $apbdes_pendapatan ? '' : 'd-none' }}"></span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="?jenis=belanja&tahun={{ $tahun }}" role="tab">
                            Belanja
                            <span class="fa fa-check-circle ml-1 {{ $belanja ? '' : 'd-none' }} "></span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="?jenis=anggaran_kegiatan&tahun={{ $tahun }}" role="tab">
                            Anggaran Bidang/Sub/Kegiatan
                            <span class="fa fa-check-circle ml-1 {{ $apbdes_belanja ? '' : 'd-none' }} "></span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="?jenis=pembiayaan&tahun={{ $tahun }}" role="tab">Pembiayaan
                            <span class="fa fa-check-circle ml-1  {{ $apbdes_pembiayaan ? '' : 'd-none' }}"></span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="?jenis=cek_struktur&tahun={{ $tahun }}" role="tab">Cek Struktur
                            APBDes
                        </a>
                    </li>
                </ul>
