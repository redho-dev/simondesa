    ...
    <div class="col-md-12 col-sm-12  ">
        ...
        <div class="x_panel">
            <div class="x_title">
                ...
                <div class="text-dark">
                    Tahun Data : {{ $tahun }} Tahun Data : {{ $tahun }} &emsp;&emsp;&emsp; <span>APBDes Murni TA {{
                        $tahun }}</span>
            ...
            <div class="x_content">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane active show " id="kewilayahan" role="tabpanel"
                        ...
                        @include('adminDesa.formApbdes.anggaran_kegiatan_tambah')
                        @elseif($jenis=='anggaran_bidangsub')
                        @include('adminDesa.formApbdes.anggaran_bidangsub_tambah')
                        @elseif($jenis=='pendapatan')
                        @include('adminDesa.formApbdes.anggaran_pendapatan_tambah')
                        @elseif($jenis=='pembiayaan')
                        @include('adminDesa.formApbdes.anggaran_pembiayaan_tambah')
                        @elseif($jenis=='dokumen')
                        @include('adminDesa.formApbdes.anggaran_dokumen_tambah')
                        @elseif($jenis=='belanja')
                        @include('adminDesa.formApbdes.anggaran_belanja_tambah')
                        @endif
