        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                    ...
                    <li class=" nav-item">
                        <a class="nav-link " href="?jenis=spp_kegiatan&tahun={{ $tahun }}" role="tab">Edit Data SPP
                            per
                            Kegiatan
                    ...
                    <li class=" nav-item">
                        <a class="nav-link " href="?jenis=cek_tbpu&tahun={{ $tahun }}" role="tab">Edit Data TBPU
                            per
                            Kegiatan
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="?jenis=bku&tahun={{ $tahun }}" role="tab">+ Pembukuan
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <h4 class="my-4 text-center">Klik Tab untuk menginput/melihat/edit data</h4>
