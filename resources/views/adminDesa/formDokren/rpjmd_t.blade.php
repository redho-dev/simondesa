...
<div class="row justify-content-center mt-2 ">
    <div class="col-md-12 col-sm-12  mb-5">
        <h5 class="alert alert-info">Form Input/Update Data RPJMDes</h5>
        <div class="x_panel">
            <div class="x_title">
                <div class="d-flex">
            ...
            <div class="text-dark">
                Tahun Data : {{ $tahun }} &emsp;&emsp; <span class="text-info">(Silahkan input data RPJMDes)</span>
        ...
        <div class="x_content">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane active show" id="dokumen_RPJMD" role="tabpanel"
                    ...
                    @if($jenis=='dokumen')
                    @include('adminDesa.formDokren.dokumen_tambah')
                    @elseif($jenis=='visi_misi')
                    @include('adminDesa.formDokren.visimisi_tambah')
                    @elseif($jenis=='potensi')
                    @include('adminDesa.formDokren.potensi_tambah')
                    @endif
