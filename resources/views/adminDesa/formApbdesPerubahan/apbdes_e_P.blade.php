            ...
            <div class="x_content">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane active show " id="kewilayahan" role="tabpanel"
                        ...
                        @include('adminDesa.formApbdesPerubahan.anggaran_kegiatan_edit_P')
                        @elseif($jenis=='pendapatan_P')
                        @include('adminDesa.formApbdesPerubahan.anggaran_pendapatan_edit_P')
                        @elseif($jenis=='pembiayaan_P')
                        @include('adminDesa.formApbdesPerubahan.anggaran_pembiayaan_edit_P')
                        @elseif($jenis=='dokumen_P')
                        @include('adminDesa.formApbdesPerubahan.anggaran_dokumen_edit_P')
                        @elseif($jenis=='belanja_P')
                        @include('adminDesa.formApbdesPerubahan.anggaran_belanja_edit_P')
                        @elseif($jenis=='cek_struktur_P')
                        @include('adminDesa.formApbdesPerubahan.strukturApbdes_P')
                        @endif
                    </div>
