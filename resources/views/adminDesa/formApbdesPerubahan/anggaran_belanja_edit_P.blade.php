<div class="mt-2">
    <p class="text-info">Form Edit/Update Data (Jenis Belanja) APBDes TA {{ $tahun }} Perubahan</p>
</div>
<div class="row">
    <div class="col-md-8">
            ...
            <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <th width="20%" class="text-primary">
                            <input type="text" class="form-control text-primary text-right belanja belanja_P "
                                name="anggaran_perubahan[]" value="{{ $bl->anggaran_perubahan }}" autofocus
                                placeholder="0">
                ...
                <tfoot>
                    <tr style="background-color: rgb(172, 175, 160)">
                        ...
                        <th width="20%"><input type="text" class="belanja text-right form-control"
                                value="{{ $total->akunbelanja_murni }}" disabled></th>
                        <th width="20%"><input type="text" name="totalBelanja"
                                class="totalBelanja belanja text-right form-control"
                                value="{{ $total->akunbelanja_perubahan }}" readonly></th>
                    </tr>

                    <tr>
                        <th colspan="4" class="text-right">
                            <button class="btn btn-primary" type="submit" name="update" value="true">UPDATE
                                DATA</button>
                        </th>
                    </tr>
                </tfoot>
