<div class="mt-2">
    <p class="text-info">Form Update Data (Anggaran Bidang/Sub-bidang/Kegiatan) APBDes TA {{ $tahun }} Perubahan</p>
</div>
<div class="row">
    <div class="col-md-12">
        <form id="kirimKeg">
            ...
            <table class="table table-bordered">
                <thead>
                    ...
                    <tr style="background-color: grey">
                        ...
                        <th class="text-right">
                            <input type="text" name="anggaran_bidang[]" value="{{ $ab->anggaran_perubahan }}"
                    ...
                    <tr class="subB_{{ $asub->bidang_id }}" style="background-color: rgb(239, 231, 231); display:none">
                        ...
                        <th class="text-right">
                            <input type="text" name="anggaran_subbidang[]"
                                ...
                                placeholder="0" value="{{ $asub->anggaran_perubahan }}" readonly>
                    ...
                    <tr class="kegB_{{ $asub->bidang_id }}" style="display: none">
                        ...
                        <th>
                            <input type="text" name="anggaran_kegiatan[]" value="{{ $akeg->anggaran_perubahan }}"
                ...
                <tfoot>
                    <tr>
                        ...
                        <th>
                            <input type="text" name="totalKegiatan" class="form-control text-right angka" id="toBlan"
                                value="{{ $total_p->belanja_perubahan }}" readonly>
                        </th>
                    </tr>
                    <tr>
                        <th colspan="2" class="text-right" style="vertical-align: middle">TOTAL JUMLAH ANGGARAN
                    ...
                    <tr>
                        <th colspan=" 3">
                            <small class="text-primary pb-0 mb-0">Silahkan update/edit data kegiatan dalam APBDes
                                Perubahan:
                            </small><br>
