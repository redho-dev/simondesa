<div class="row">
    <div class="col-md-5">
        <p class="text-info">Form Input Data (Pendapatan) APBDes TA {{ $tahun }} Perubahan</p>

    </div>
    <div class="col-md-3">
        <small>
            <p class="text-right text-primary">Silahkan Input Data Pendapatan Perubahan sesuai Siskeudes
                        ...
                        <tr style="background-color: rgb(215, 215, 223)">
                            ...
                            <th width="20%">
                                <input type="text "
                                    ...
                                    placeholder="0" name="pendapatan[]" autofocus value=0>
                        ...
                        <tr>
                            ...
                            <th width="20%">
                                <input type="text" class="form-control text-primary text-right pendapatan transfer"
                                    name="pendapatan[]" placeholder="0" autofocus value=0>
                                <input type="hidden" name="pendapatan_id[]" value="{{ $pd->pendapatan_id }}">
                            </th>
                        </tr>
                        @endif
                    ...
                    <tr>
                        ...
                        <th>
                            <input type="text" class="form-control text-right pendapatan total_p" autofocus
                                style="font-size: .9rem" value=0 readonly>
                        </th>
                    </tr>
                    <tr>
                        <th colspan="2">
                            <small>
                                Catatan :
                                <ul>
                                    <li>Silahkan edit jumlah jenis pendapatan jika ada perubahan dari anggaran awal</li>
                        ...
                        <th colspan="2" class="text-right"><button class="btn btn-primary" type="submit">KIRIM
                                DATA</button></th>
                    </tr>
                </tfoot>
