<div class="mt-2">
    <p class="text-info">Form Input Data (Pembiayaan) APBDes TA {{ $tahun }} Perubahan</p>
</div>
<div class="row">
    <div class="col-md-8">
            ...
            <table class="table table-bordered">
                <thead>
                    <tr style="background-color: rgb(183, 197, 197)">
                        ...
                        <th width="20%">Anggaran Perubahan (Rp)</th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <th class="text-right">
                            <input type="text" class="form-control text-right pembiayaan" name="pembiayaan_perubahan"
                                autofocus style="font-size: .9rem" id="netto" readonly>
                        </th>
                    </tr>
                    <tr>
                        <th colspan="3">
                            <small class="text-primary">
                                Catatan :
                                <ul>
                                    <li>Silahkan edit jumlah pembiayaan perubahan pada setiap jenis pembiayaan yang
                                        berubah</li>
