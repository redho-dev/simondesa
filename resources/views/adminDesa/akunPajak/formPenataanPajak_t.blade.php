...
<div class="row justify-content-center mt-2 mb-4">
    <div class="col-md-12 col-sm-12  ">
        <h5 class="alert alert-info">Form Input Data Penatausahaan Pajak</h5>
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ $jenis=='buku' ? 'active' : '' }}" href="?jenis=buku&tahun={{ $tahun }}"
                            role="tab">Buku Pembantu pajak
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        @if($jenis=='billing')
                        @include('adminDesa.akunPajak.billingTambah')
                        @elseif($jenis=='buku')
                        @include('adminDesa.akunPajak.bukuPajakTambah')
                        @endif
...
<script>
    ...
    $('.billing_lainnya').on('change', function(e){
        e.preventDefault();
        var file = $(this).val();
        getURL2(this, file);
    ...
    if (input.files && input.files[0]) {
        ...
        if (cekgb == 'pdf' || cekgb == 'PDF') {
            if(input.files[0]['size'] > 1024000){
                ...
                $('.nama_file3').html("File PDF (max-size: 1MB)");
            }else{
