...
<div class="row">
    <div class="col-md-12">
        <table class="table table-bordered">
            <tr style="background-color: rgb(175, 250, 250)">
                <th>#</th>
            ...
            <tr class=" {{ $bkp->billing_pph || $bkp->billing_ppn ? 'text-primary' : '' }}">
                ...
                <td class="angka text-right pr-4">{{ $bkp->jumlah }}</td>
                <td>
                    <ul class="pl-2">
                ...
                <td class="text-center">
                    <div class="d-flex justify-content-center">
                        ...
                        <form action="/adminDesa/hapusBilling" method="post">
                            ...
                            <input type="hidden" name="tolalpajak" value="{{ $totalpajak }}">
