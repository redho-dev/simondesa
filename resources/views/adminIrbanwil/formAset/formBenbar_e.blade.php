                ...
                <div class="tab-pane active show " id="aset" role="tabpanel" aria-labelledby="aset-tab">
                    <div class="row my-4">
                        <div class="col-md-6 alert alert-info">
                            <span>Silahkan Update Data Pengurus/Bendahara Barang Desa Tahun {{
                                $tahun }}, Jika Ada Perubahan</span>
                        </div>
                    </div>

                    <form action="/adminDesa/editBenbar" method="post" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="asal_id" value=" {{ $infos->asal_id }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="nama" class="form-control" style="font-size: .85rem"
                                    value="{{ $datas->nama }}" required autofocus>
                            </div>
                        </div>
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4 mt-2">
                                <div class="row">
                                    <div class="col-md-3">
                                        <a href="{{ asset('storage/'.$datas->sk_benbar) }}" target="_blank"><img
                                                src="{{ asset('/img/logo-pdf.jpg') }}" width="60px"></a>
                                    </div>
                                    <div class="form-group col-md-9">
                                        <div class="input-group">
                                            <div class="custom-file py-0">
                                                <input type="hidden" name="oldPdf" value="{{ $datas->sk_benbar }}">
                                                <input type="file" name="sk_benbar" class="custom-file-input"
                                                    id="sk_benbar">
                                                <label class="custom-file-label text-muted sk_benbar"
                                                    for="sk_benbar">Choose
                                                    file PDF
                                                    (max-size: 1MB)</label>
                                            </div>
                                        </div>
