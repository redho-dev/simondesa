...
<div class="row justify-content-center mt-2">
    <div class="col-md-12 col-sm-12  ">
        <h5 class="alert alert-info">RESUME / NOTA HASIL PENGAWASAN</h5>
        <div class="x_panel">
            <div class="x_title">
            ...
            <div class="x_content">
                @if($error == '')
                @include('adminIrbanwil.NHP_LHP.pemerintahan')
                @include('adminIrbanwil.NHP_LHP.keuangan')
                @endif
            </div>
        </div>
    </div>
...
<script>
    ...
    $('.angka').mask('000.000.000.000', {reverse: true});
</script>
