...
<div class="card p-4">
    <form action="/adminIrbanwil/catatantemuan" method="post">
        <div class="row align-items-center">
            ...
            <div class="col-md-4 text-right">
                <span class="d-none" id="status_lhp">{{ Pembantu::status($tahun) }}</span>
                <p class="text-info" style="font-size: 1rem">{{ Pembantu::statusL($tahun)}}</p>
