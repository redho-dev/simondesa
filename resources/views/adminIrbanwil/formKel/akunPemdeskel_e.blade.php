...
<div class="row justify-content-center mt-2">
    <div class="col-md-12 col-sm-12  ">
        <h5 class="alert alert-info">Penilaian Indikator : Kelembagaan</h5>
        <div class="x_panel">
            <div class="x_title">
            ...
            <div class="x_content">
                ...
                <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link {{ $jenis=='akunkel' ? 'active' : '' }}"
                            href="?jenis=akunkel&tahun={{ $tahun }}" role="tab">Kelembagaan
                            <span class="fa fa-check-circle ml-1 {{ $akunkel==0 ? 'd-none' : '' }}"></span>
                        </a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane active show " id="kewilayahan" role="tabpanel"
                        ...
                        @if($jenis=='akunkel')
                        @include('adminIrbanwil.formKel.dataKelembagaan')
                        @elseif($jenis=='penilaian')
                        @include('adminIrbanwil.formKel.nilaiAkunkel_e')
                        @endif
                    </div>
