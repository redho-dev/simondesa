...
<div class="row justify-content-center mt-2">
    <div class="col-md-12 col-sm-12  ">
        <h5 class="alert alert-info">Penilaian Indikator : Pengadaan Barang dan Jasa (Pembangunan Fisik dan Pengadaan
            Aset Tetap Kantor)</h5>
        <div class="x_panel">
            <div class="x_title">
            ...
            <div class="x_content">
                <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link  {{ $jenis=='penilaian' ? 'active' : '' }} {{ $cekperbaikan ? 'text-danger' : '' }}"
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane active show " id="kewilayahan" role="tabpanel"
                        ...
                        @include('adminIrbanwil.formPengadaan.nilaiAkunbarjas_e')
