...
<div class="row justify-content-center mt-2">
    <div class="col-md-12 col-sm-12  ">
        <h5 class="alert alert-info">Penilaian Indikator : Administrasi Umum</h5>
        <div class="x_panel">
            <div class="x_title">
            ...
            <div class="x_content">
                ...
                <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link {{ $jenis=='adum' ? 'active' : '' }}" href="?jenis=adum&tahun={{ $tahun }}"
                            role="tab">Administrasi Umum
                            <span class="fa fa-check-circle ml-1 {{ $adum==0 ? 'd-none' : '' }}"></span>
                        </a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane active show " id="kewilayahan" role="tabpanel"
                        ...
                        @if($jenis=='penilaian')
                        @include('adminIrbanwil.formAdum.nilaiAkunadum_e')
                        @elseif($jenis == 'adum')
                        @include('adminIrbanwil.formAdum.dataAdum')
                        @endif
                    </div>
