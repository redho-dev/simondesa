            ...
            <div class="x_content">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane active show " id="kewilayahan" role="tabpanel"
                        ...
                        @if($jenis=='penilaian')
                        @include('adminIrbanwil.pendapatan.nilaiAkunpendapatan_e')
                        @elseif($jenis=='pengajuan')
                        @include('adminIrbanwil.pendapatan.dataPengajuan')
                        @elseif($jenis=='cek_pengajuan')
                        @include('adminIrbanwil.pendapatan.cekPengajuan')
                        @elseif($jenis=='buku_pembantu_bank')
                        @include('adminIrbanwil.pendapatan.databukuBank')
                        @else
