...
<div class="row justify-content-center mt-2">
    <div class="col-md-12 col-sm-12  ">
        <h5 class="alert alert-info">Penilaian Indikator : Kewilayahan</h5>
        <div class="x_panel">
            <div class="x_title">
            ...
            <div class="x_content">
                ...
                <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link {{ $jenis=='akunwil' ? 'active' : '' }}"
                            href="?jenis=akunwil&tahun={{ $tahun }}" role="tab">Kewilayahan
                            <span class="fa fa-check-circle ml-1 {{ $akunwil==0 ? 'd-none' : '' }}"></span>
                        </a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane active show " id="kewilayahan" role="tabpanel"
                        ...
                        @if($jenis=='akunwil')
                        @include('adminIrbanwil.formWil.dataKewilayahan')
                        @elseif($jenis=='penilaian')
                        @include('adminIrbanwil.formWil.nilaiAkunwil_e')
                        @endif
                    </div>
