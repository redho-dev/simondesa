...
<div class="row justify-content-center mt-2">
    <div class="col-md-12 col-sm-12  ">
        <h5 class="alert alert-info">Cek Kesesuaian APB Desa <span class="text-warning">Perubahan</span> TA {{ $tahun }}
            dengan Input Data Simondes</h5>
        <div class="x_panel">
            <div class="x_title">
            ...
            <div class="x_content">
                ...
                <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link {{ $jenis=='apbdesm' ? 'active' : '' }}"
                            href="?jenis=apbdesm&tahun={{ $tahun }}" role="tab">Data APBDes Perubahan
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane active show " id="kewilayahan" role="tabpanel"
                        ...
                        @if($jenis=='apbdesm')
                        @include('adminIrbanwil.cekApbdes.dataApbdes_p')
                        @elseif($jenis=='catatan')
                        @include('adminIrbanwil.cekApbdes.catatanApbdes_p_e')
                        @endif
                    </div>
