            ...
            <div class="x_content">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane active show " id="kewilayahan" role="tabpanel"
                        ...
                        @if($jenis=='pernyataan')
                        @include('adminIrbanwil.kemandirian.pernyataan')
                        @elseif($jenis=='sertifikat')
                        @include('adminIrbanwil.kemandirian.sertifikat')
                        @elseif($jenis=='hasil')
                        @if($hasil)
                        @include('adminIrbanwil.kemandirian.hasil_e')
                        @else
                        @include('adminIrbanwil.kemandirian.hasil')
                        @endif
                        @elseif($jenis=='penilaian')
                        @if($rekap)
                        @include('adminIrbanwil.kemandirian.nilaiKemandirian_e')
                        @else
                        @include('adminIrbanwil.kemandirian.nilaiKemandirian')
                        @endif
                        @endif
