<div class="row ">
    <div class="col-md-8 mt-2">
        ...
        <form action="/adminIrbanwil/nilaiAkunKemandirianUpdate" method="post">
            @csrf
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr class="{{ $datnilPernyataan->perbaikan ? 'text-danger' : '' }}">
                        <td>1</td>
                        ...
                        <td class="text-center" style="vertical-align: middle">
                            ...
                            <input type="number" class="form-control text-center" style="font-size: .85rem"
                                name="nilai[]" autofocus value="{{ $datnilPernyataan->nilai_sementara }}" required>
                        </td>
                        <td class="text-center bg-secondary" style="vertical-align: middle">{{
                            $datnilPernyataan->skor }}</td>
                    </tr>
                    <tr class="{{ $datnilSertifikat->perbaikan ? 'text-danger' : '' }}">
                        <td>2</td>
                        ...
                        <td class="text-center" style="vertical-align: middle">
                            ...
                            <input type="number" class="form-control text-center" name="nilai[]"
                                style="font-size: .85rem" value="{{ $datnilSertifikat->nilai_sementara }}" required>
                        </td>
                        <td class="text-center bg-secondary" style="vertical-align: middle">{{
                            $datnilSertifikat->skor }}</td>
                    </tr>
                    <tr class="{{ $datnilHasil->perbaikan  ? 'text-danger' : ''}}">
                        <td>3</td>
                        <td>Hasil Uji Penguasaan Siskeudes</td>
                        <td class="text-center bg-secondary" style="vertical-align: middle">25</td>
                        <td class="text-center" style="vertical-align: middle">{{ $datnilHasil->persen_data }}
                        </td>
                        <td class="text-center" style="vertical-align: middle">
                            <input type="hidden" name="sub_indikator_keuangan_id[]" value=23>
                            <input type="number" class="form-control text-center" name="nilai[]"
                                style="font-size: .85rem" value="{{ $datnilHasil->nilai_sementara }}" required readonly>
                        </td>
                        <td class="text-center bg-secondary" style="vertical-align: middle">
                            @if($datnilHasil->perbaikan)
                            <span></span>
                            @else
                            {{ $datnilHasil->skor }}
                            @endif
                ...
                <tr>
                    <td colspan="6" style="background-color: beige">
                        ...
                        <p class="mb-1">SECARA UMUM KEMANDIRIAN TATAKELOLA KEUANGAN TAHUN ANGGARAN {{ $tahun
    ...
    <div class="col-md-3 mt-2">
        <p class="alert alert-info" style="font-size: 1rem">Capaian Indikator : </br>Kemandirian Tata Kelola Keuangan
        </p>
        <div class="card p-2">
