<div class="row ">
    <div class="col-md-8 mt-2">
        ...
        <form action="/adminIrbanwil/nilaiAkunPajakUpdate" method="post">
            @csrf
            ...
            <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="text-center" style="vertical-align: middle">
                            ...
                            <input type="number" class="form-control text-center" name="nilai[]"
                                style="font-size: .85rem" value="{{ $datnilBPP->nilai_sementara }}" required>
                        </td>
                        <td class="text-center bg-secondary" style="vertical-align: middle">
                            {{ $datnil[2]->skor }}
                        </td>
                ...
                <tr>
                    <td colspan="6" style="background-color: beige">
                        ...
                        <p class="mb-0">SECARA UMUM KETAATAN PAJAK TAHUN ANGGARAN {{ $tahun
    ...
    <div class="col-md-3 mt-2">
        <p class="alert alert-info" style="font-size: 1rem">Capaian Indikator : </br>Kepatuhan Pajak</p>
        <div class="card p-2">
