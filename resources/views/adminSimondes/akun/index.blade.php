        ...
        <div class="col">
            <section class="card">
                <header class="card-header">
                    <a class="modal-with-form btn btn-primary btn-sm" href="#tambah"><i class="fa fa-plus-circle"></i> Tambah Data</a>
                    ...
                    <table class="table table-bordered table-striped mb-0" id="datatable-default">
                        ...
                        <tbody>
                            ...
                            <tr>                                
                                ...
                                <td>{{ $dt->username }}</td>
                                <td>{{ $dt->obrik }}</td>                                
                                <td style="width:10%; white-space: nowrap;"><a type="button" class="modal-with-form btn btn-success btn-sm" title="Ubah Data Verifikator Inspektorat" href="#ubah{{ $dt->id }}"><i class="fa fa-edit"></i></a> <a id="btn-delete" data-id="{{ $dt->id }}" class="btn btn-danger btn-sm btn-delete" title="Hapus Data Admin"><i class="fa fa-trash"></i></a>                                    
                                </td>
                            </tr>                            
                            @endforeach                            
                        </tbody>
...
<div id="ubah{{ $up->id }}" class="modal-block modal-header-color modal-block-success mfp-hide">
    <section class="card">
        <header class="card-header">
