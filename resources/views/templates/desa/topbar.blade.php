...
<div class="top_nav">
    <div class="nav_menu bg-info">
        ...
        <div class="nav toggle mt-3" style="width: 40vw;">
            ...
            <span class="text-warning ">ADMIN KEUANGAN DESA {{ strtoupper($infos->asal->asal) }} , KECAMATAN {{
                strtoupper($infos->asal->kecamatan) }}</span>
            @else
            ...
            <ul class=" navbar-right">
                ...
                <li class="nav-item dropdown open" style="padding-left: 15px;">
                    <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown"
                        ...
                        <img src="/img/admin.png" alt="">{{ $infos->name }}
                    </a>
