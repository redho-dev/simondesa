...
class AkunPemdesadumController extends Controller
{
    public function adum(Request $request)
    {
        $tahun = now()->format('Y');
        ...
        if (isset($request->jenis)) {
            ...
            if ($datum == 0) {
                ...
                return view('adminIrbanwil.formAdum.akunPemdesadum', [
                    'desa' => $desa,
                    'infos' => $infos,
                    'asal_id' => $asal_id,
                    'jenis' => $request->jenis,
                ...
                return view('adminIrbanwil.formAdum.akunPemdesadum_e', [
                    'desa' => $desa,
                    'asal_id' => $asal_id,
                    'infos' => $infos,
                    'jenis' => $request->jenis,
    ...
    public function nilaiAkunadum(Request $request)
    {
        ...
        foreach ($request->sub_indikator_pemerintahan_id as $sub) {
            ...
            if (!$cek) {
                ...
                $data["nilai_sementara"] = $request->nilai[$i - 34];
                ...
                $ubah = Nilai_pemerintahan::where([
                    ...
                    'nilai_sementara' => $request->nilai[$i - 34],
                    'perbaikan' => false
                ]);
            }
    ...
    public function tamcaAdum(Request $request)
    {
        $data = [
            'asal_id' => $request->asal_id,
            'tahun' => $request->tahun,
    ...
    public function nilaiAkunadumEdit(Request $request)
    {
