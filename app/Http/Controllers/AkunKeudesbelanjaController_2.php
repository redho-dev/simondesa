...
class AkunKeudesbelanjaController extends Controller
{
    ...
    public function nilaiSPP(Request $request)
    {
        ...
        return back()->with('success', 'berhasil kirim nilai dan catatan');
    }
    ...
    public function nilaiAkunbelanja(Request $request)
    {
        ...
        $data['catatan_sementara'] = strip_tags($request->catatan_sementara);
        $data['rekom_sementara'] = strip_tags($request->rekom_sementara);
    ...
    public function nilaiAkunbelanjaUpdate(Request $request)
    {
        ...
        Catatan_keuangan::where([
            ...
            'catatan_sementara' => strip_tags($request->catatan_sementara),
            'rekom_sementara' => strip_tags($request->rekom_sementara)
        ]);
